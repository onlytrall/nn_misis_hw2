...
from algorithms.sampling_generation_wth_temperature import sampling_generate
...
if __name__ == "__main__":
  ...
  all_text, generated = sampling_generate(model=model, tokenizer=tokenizer, system_prompt=config.system_prompt, prompt=config.prompt, temperature=config.temperature)
  
  # print(all_text)
  print(tokenizer.decode(generated).encode("utf-8"))
